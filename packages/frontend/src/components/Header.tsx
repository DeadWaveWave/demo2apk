    ...
    <header className="blueprint-box p-6 flex items-center justify-between bg-bp-panel border-b border-bp-blue/30 relative">
      ...
      <div className="flex items-center gap-6">
        ...
        <a
          ...
          className="group flex items-center gap-3 px-4 py-2 border border-bp-grid hover:border-amber-400 bg-bp-dark/50 hover:bg-amber-400/10 transition-all duration-300 relative"
        >
          {/* Corner accents */}
          ...
          {/* GitHub Icon */}
          <svg
            className="w-5 h-5 text-bp-dim group-hover:text-white transition-colors"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          <div className="flex items-center gap-1.5">
            <svg
              className="w-4 h-4 text-amber-400 group-hover:animate-pulse"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
              <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
            </svg>
            <span className="font-mono text-sm text-bp-dim group-hover:text-amber-400 transition-colors">
              {starCount !== null ? starCount.toLocaleString() : t('common.loading', { defaultValue: '...' })}
            </span>
          </div>

          {/* Divider */}
          <div className="h-4 w-[1px] bg-bp-grid" />

          {/* CTA Text */}
          <span className="font-mono text-xs text-bp-dim group-hover:text-amber-400 transition-colors uppercase tracking-wider">
            {t('header.starCta')}
          </span>
        </a>
      </div>
