...
export default function LanguageSwitcher() {
  ...
  return (
    <div className="flex items-center gap-3 text-xs font-mono uppercase tracking-wider text-bp-dim">
      <span className="text-bp-blue/70">{t('language.label')}</span>
        ...
        {LANG_OPTIONS.map((option, index) => {
          ...
          return (
            <button
              ...
              className={`px-3 py-1 flex items-center gap-2 transition-all duration-200 ${
                isActive
            ...
            >
              <span className="text-[10px] tracking-[0.2em]">{option.code.toUpperCase()}</span>
