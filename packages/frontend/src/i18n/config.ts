    ...
    en: {
        translation: {
            ...
            guide: {
                ...
                collapse: '[COLLAPSE]',
                expand: '[EXPAND]',
                intro: 'One-click package code generated by AI (Gemini, ChatGPT, DeepSeek, etc.) into an Android App.',
                modeA_title: 'MODE A: SINGLE FILE',
                modeA_desc: 'Upload a single code file (supports .html, .js, .jsx, .ts, .tsx). We automatically detect and package it.',
                modeB_title: 'MODE B: PASTE CODE',
                modeB_desc: 'Copy code from ChatGPT/Gemini/Claude etc. and paste it here. We automatically detect and package it.',
                modeC_title: 'MODE C: ZIP ARCHIVE',
                modeC_desc: 'For ZIPs from AI Studio, V0, etc. Support HTML projects and React/Vite projects.',
                permissions_title: 'PERMISSIONS',
                permissions_desc: 'Configure Android permissions in Advanced Settings (optional, defaults to INTERNET access).',
            },
            upload: {
...
// 3. Plain JavaScript/TypeScript`,
                ...
                permissionsInfo: 'Select permissions your app needs. Default includes INTERNET access.',
                permissionsDefaults: 'Defaults',
                permissionsAll: 'All',
                permissionsClear: 'Clear',
                permissionsShowMore: 'Show More Categories',
                permissionsShowLess: 'Show Less',
                permissionsSelected: 'permissions selected',
                permissionsDangerousNote: 'Includes sensitive permissions',
                permissionsCatNetwork: 'Network',
                permissionsCatStorage: 'Storage',
                permissionsCatCamera: 'Camera & Audio',
    ...
    zh: {
        translation: {
            ...
            guide: {
                ...
                collapse: '[收起]',
                expand: '[展开]',
                intro: '专为 AI 编程打造。将 Gemini、ChatGPT、DeepSeek 等 AI 生成的代码一键打包成安卓 App。',
                modeA_title: '模式 A：单文件',
                modeA_desc: '上传单个代码文件（支持 .html, .js, .jsx, .ts, .tsx），我们会自动识别并打包。',
                modeB_title: '模式 B：粘贴代码',
                modeB_desc: '复制 ChatGPT/Gemini/Claude 等 AI 生成的代码并粘贴到这里，我们会智能识别并打包。',
                modeC_title: '模式 C：ZIP 压缩包',
                modeC_desc: '适用于从 AI Studio、V0 等平台下载的压缩包。支持 HTML 项目和 React/Vite 项目的 ZIP 压缩包。',
                permissions_title: '权限配置',
                permissions_desc: '在高级设置中配置安卓权限（可选，默认只包含网络访问权限）。',
            },
            upload: {
...
// 3. 普通 JavaScript/TypeScript 代码`,
                ...
                permissionsInfo: '选择应用需要的权限。默认包含网络访问权限。',
                permissionsDefaults: '默认',
                permissionsAll: '全选',
                permissionsClear: '清除',
                permissionsShowMore: '显示更多分类',
                permissionsShowLess: '收起',
                permissionsSelected: '个权限已选择',
                permissionsDangerousNote: '包含敏感权限',
                permissionsCatNetwork: '网络',
                permissionsCatStorage: '存储',
                permissionsCatCamera: '相机和音频',
